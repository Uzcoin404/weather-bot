...
$telegram = new Telegram(getenv("BOT_TOKEN"), true);
$api = new Api(getenv("API_KEY"));
...
function gettingReady(){
    ...
    [$telegram->buildKeyboardButton('🕹 Ertaga'), $telegram->buildKeyboardButton('🕹 7 Kunlik')],
    [$telegram->buildKeyboardButton('🏠 Bosh sahifa')]]);
